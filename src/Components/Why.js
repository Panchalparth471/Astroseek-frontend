...
{
    return (
        <div className="w-100vw p-4 h-[700px] max-sm:mt-8 flex flex-col items-center justify-evenly">
            <div><h1 className="text-center font-semibold text-[#FF8A00] text-[50px] max-sm:text-[30px]">Why Astrology?</h1></div>
            <div className="max-w-[1050px] p-1 text-[20px] max-sm:text-[15px] max-[300px]:text-[12px] font-medium">
