...
export default function Footer() {
    return (
        <div className='w-[100vw] mt-32 max-sm:mt-28 text-white bg-[#FF8A00] h-[340px] max-lg:h-[570px] px-8 max-lg:px-0 max-lg:justify-evenly flex justify-between items-center max-lg:flex-col'>
                ...
                <div className='flex flex-col items-center'>
                 <div className='flex flex-col items-center w-full gap-4 font-medium text-[20px] max-lg:text-[15px]'><h1 className='w-full text-center flex flex-col items-center text-[30px] max-lg:text-[22px] max-[300px]:text-[18px] font-normal'>Coorporate Info <div className='bg-white rounded-lg w-10 h-1'></div></h1>
                   ...
                   <div className='flex flex-col items-center font-medium text-[20px] max-lg:text-[15px]'>
                    ...
                    <div className='w-full flex justify-center cursor-pointer'><a href='/compatibility' className='w-full text-center'>Compatibility</a></div>
                    <div className='w-full flex justify-center cursor-pointer'><a href='/horoscope' className='w-full text-center'>Horoscope</a></div>
                    <div className='w-full flex justify-center cursor-pointer'><a href='/signup' className='w-full text-center'>Astrologers</a></div>
                    <div className='w-full flex justify-center cursor-pointer'><a href='/signup' className='w-full text-center'>Talk to Astrologer</a></div>
                </div>    
                </div>
            </div>
